...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      {/* Reduced blob sizes for faster paint */}
      <div className="blob blob-teal w-[500px] h-[500px] -top-24 -left-24 animate-glow-pulse" />
      <div className="blob blob-violet w-[400px] h-[400px] top-1/4 right-0 animate-glow-pulse" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container mx-auto relative z-10 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Left column â€” CSS fade-in, no JS needed */}
